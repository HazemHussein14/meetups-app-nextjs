...
async function getStaticPaths() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://Hazem-Hussein:Jh1Jf7PdoecjzLsO@cluster0.8bedofn.mongodb.net/?retryWrites=true&w=majority");
    const db = client.db();
